...
For skills: list each distinct skill only ONCE across the whole resume, even if it's mentioned in multiple sections (a summary, a skills list, and inside a bullet point) - merge these into a single entry rather than repeating it. Classify each skill's category as one of: technical (programming languages, frameworks, engineering practices), tool (specific software/platforms), domain (industry or functional knowledge, e.g. "healthcare compliance", "supply chain"), leadership (people/team management, mentoring, stakeholder management), soft (communication, collaboration, adaptability), language (spoken/written human languages), or other. Set proficiency or yearsExperience ONLY when the resume text itself states or clearly implies it for that specific skill (e.g. "Expert in Python", "5 years of React") - leave both null rather than guessing or inferring from job titles/seniority.`;
